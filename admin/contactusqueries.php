   ...
   <div class="table table-bordered table-striped">
      <table class="table">
         ...
         $nrt = "Not Replied Yet";
            ...
            $result = mysqli_query($db, $selectpro);
            ...
            <td>
                ...
                ?></td>
            <td><a
            href='contactusreply.php?queryid=<?php echo $row[0]; ?>&emailid=<?php echo $row[1]; ?>&query=<?php echo $row[2]; ?>' class='btn btn-warning'> <i class='fas fa-edit'></i> Reply</a>
            </td>
            <td>       
